...
require('./srv/zero.js')
nocache('./srv/zero.js', module => console.log(`${module} Telah Di Updated... Jangan Lupa Subscribe SiFzz`))
...
zero.browserDescription = [ 'SiFzz', 'Firefox', '3.0' ]
console.log(banner.string)
console.log(color('[•] [ CREATED BY SiFzz ] [•]'))
console.log(color('Please Follow Me On Sosial Media'))
console.log(color(' ==============================================='))
console.log(color('│ ○ Youtube : https://youtube.com/channel/UCH5A7ZhfF5eIEjWzLzIRHaA             '))
console.log(color('│ ○ Instagram : https://instagram.com/xgame.sanz           '))
console.log(color('│ ○ Tiktok : https://tiktok.com/@sif_78                  '))
console.log(color('│ ○ Github : https://github.com/gugurko                      '))
console.log(color(' ==============================================='))
zero.on('qr', () => {
...
zero.on('open', () => {
success('2', 'Bot Telah Tersambung... Jangan Lupa Subscribe SiFzz')
})
...
zero.sendMessage(anu.jid, "𝐇𝐚𝐲!.. 𝐒𝐚𝐲𝐚 SiFzz 𝐒𝐚𝐲𝐚 𝐀𝐤𝐚𝐧 𝐌𝐞𝐦𝐛𝐚𝐧𝐭𝐮 𝐌𝐞𝐦𝐛𝐚𝐧𝐭𝐮 𝐌𝐞𝐦𝐩𝐞𝐫𝐦𝐮𝐝𝐚𝐡 𝐊𝐢𝐧𝐞𝐫𝐣𝐚 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐒𝐞𝐩𝐞𝐫𝐭𝐢 𝐌𝐞𝐦𝐛𝐮𝐚𝐭 𝐒𝐭𝐢𝐜𝐤𝐞𝐫 𝐃𝐚𝐧 𝐋𝐚𝐢𝐧 𝐋𝐚𝐢𝐧.", "conversation")
}
...
sendButImage(anu.jid, teks, `©Created By KingOfBear`, img,but = [{buttonId:`hallo`, 
...
sendButImage(anu.jid, teks, `©Created By SiFzz`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `SELAMAT TINGGAL!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
