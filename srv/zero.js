...
var num = "6283856223089@s.whatsapp.net"
var ownerNumber = [`${NomorOwner}@s.whatsapp.net`,"6283856223089@s.whatsapp.net"]
...
costum(buffer, sticker, Verived, `𝐉𝐚𝐧𝐠𝐚𝐧 𝐋𝐮𝐩𝐚 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 SiFzz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe SiFzz`)
fs.unlinkSync(ran)
})
break
case 'stickerwm':
...
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@sif_78`
zero.sendMessage(from, teks, text, {quoted: ftrol})
break
case "runtime":
case "test":
...
teks =
`[ INFO SCRIPT ]
• Youtube Creator : SiFzz

[ LINK SCRIPT ]
• https://github.com/gugurko
...
case 'nulis':
           if (args.length == 0) return reply(`Example: ${prefix + command} Bot | Indo`)
                    ...
                    zero.sendMessage(from, buffer, image, { quoted: ftrol, caption: 'Done Nih....  Jangan Lupa Subscribe SiFzz'})
                    break
                    case 'delchat':
...
Gak Bisa Jawab Wajib Subsribe SiFzz`
...
Gak Bisa Jawab Wajib Subscribe SiFzz`
...
zero.sendMessage(from, asupan, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe SiFzz'})
break
case 'asupanfilminfo':
...
buttonsMessage = {footerText:'©Created By SiFzz', imageMessage: imageMsg,
contentText:`Done Nih... Jangan Lupa Subscribe SiFzz`,buttons,headerType:4}
...
contentText: `Done Nih... Jangan Lupa Subscribe SiFzz`,
footerText: '©Created By SiFzz',
buttons: but,
headerType: 4
}
...
zero.sendMessage(from, pro, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe SiFzz'})
break
...
zero.sendMessage(from, ig, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe SiFzz'})
break
case 'igtv':
reply(mess.wait)
...
ig = await getBuffer(ig.result.link)
zero.sendMessage(from, ig, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe SiFzz'})
break
case 'tiktoknowm':
reply(mess.wait)
...
await zero.sendMessage(from, hasil, video, {quoted: ftrol, caption : 'Done Nih... Jangan Lupa Subscribe SiFzz'})
break
case 'tiktokwm':
reply(mess.wait)
if(!q)return reply('Link Video Tiktok Nya Mana ?')
...
await zero.sendMessage(from, hasil, video, {quoted: ftrol, caption : 'Done Nih... Jangan Lupa Subscribe King Of Bear'})
break
case 'play':
reply(mess.wait)
